#Implemente uma função que realiza uma travessia inordem 
#(esquerda-raiz-direita) em uma árvore binária e retorna os valores dos nós visitados.
